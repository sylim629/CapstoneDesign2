	...
	public DaySelector(Component comp, Callbacks callback, Date date) {
		...
		ActionListener comboChanged = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Integer selectedYear = Integer.valueOf((String) yearCombo.getSelectedItem());
				Integer selectedMonth = Integer.valueOf((String) monthCombo.getSelectedItem());
		...
		selectButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				dateCallback.onUpdatedDate(Integer.valueOf((String) yearCombo.getSelectedItem()),
						monthCombo.getSelectedIndex() + 1, dayCombo.getSelectedIndex() + 1,
						hourCombo.getSelectedIndex(), minuteCombo.getSelectedIndex());
				setVisible(false);
			}
		});
